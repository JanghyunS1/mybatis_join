...
public class BoardController {
	/*
	 	...
	 	인터페이스를 객체 주입해서 구현을 해놓아야 유지 보수를 쉽게 할 수 있다.
	...
	public String updateBoard(@ModelAttribute("board") BoardVO vo) { 		// BoardVO를 "board"라는 이름으로 ModelAttribute 설정
		System.out.println("글 수정 처리 - Spring MVC Annotation 호출 - Controller 통합");
	...
	public String deleteBoard(BoardVO vo) {
		System.out.println("글 삭제 처리- Spring MVC 어노테이션 호출 - Controller 통합");
	...
	public String getBoardList( BoardVO vo, Model model) {
		...
		/*	@ModelAttribute:
		 	1. Command 객체로 전송되는 객체이름을 다른 이름으로 변경
		 	2. View에서 사용할 데이터 설정하는 용도로 사용
